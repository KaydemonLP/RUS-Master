...
const char* iotHubHost = "HUB-RUS-KAY-21.azure-devices.net";
...
const char* ssid = "Bohnec"; // WIFI ime
const char* pass = "BOBIJEVAMREZA"; // WIFI PASSWORD
...
String getTelemetryData(float percentage) { // Get the data and pack it in a JSON message
...
void sendTelemetryData(float percentage) {
  String telemetryData = getTelemetryData(percentage);
